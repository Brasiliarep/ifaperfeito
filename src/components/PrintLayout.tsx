                    ...
                    <div className="flex justify-center gap-4 flex-wrap">
                        {onReturnToSession && (
                            <button
                                ...
                                className="border border-ifa-gold text-ifa-gold hover:bg-ifa-gold/10 px-6 py-2 rounded-lg font-bold uppercase text-sm flex items-center gap-2 transition-all"
                            >
                                <ArrowLeft size={16} /> Voltar à Consulta
                            </button>
                        )}
                        <button onClick={onBack} className="text-gray-400 hover:text-white underline py-2 text-sm">
                            {onReturnToSession ? 'Encerrar Sessão' : 'Voltar'}
                        </button>
