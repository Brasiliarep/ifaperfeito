...
export const DB_IWOSAN: OogunItem[] = [
    ...
    { id: 'iw_ale_okunrin', title: 'Impotência', category: 'health', subCategory: 'iwosan', purpose: 'Vigor masculino.', nomeYoruba: 'Oogun Ale', complexity: 'Alta', tags: ['Sexual'], oduReference: 'Obarabogbe', niveis: [{ tipo: 'COMPLETO', estimativa_materiais: 200, materiais: ['Igi Orogbo (Raiz de Amargoso)', 'Oti (Gim/Cachaça)', 'Oyin (Mel)'], preparo: ['Curtir a raiz no Oti por 7 dias.', 'Beber um cálice.'], ofo: 'Okunrin dide.', traducao: 'Homem levante-se.' }] },
...
export const DB_IMULE: OogunItem[] = [
    ...
    { id: 'im_osanyin_ewe', title: 'Pacto com Osanyin', category: 'health', subCategory: 'imule', purpose: 'Poder das ervas.', nomeYoruba: 'Imule Osanyin', complexity: 'Alta', tags: ['Osanyin', 'Ervas'], oduReference: 'Odi', niveis: [{ tipo: 'COMPLETO', estimativa_materiais: 400, materiais: ['Efin (Fumo de Rolo)', 'Oti (Cachaça/Gim)', 'Ewe Osanyin (Ervas da Mata)'], preparo: ['Oferenda na mata.'], ofo: 'Osanyin, jowo ewe.', traducao: 'Osanyin, entregue as ervas.' }] },
...
export const DB_GIGA: OogunItem[] = [
    ...
    {
        id: 'gi_ipadabo_ori',
        title: 'Ìpadàbọ̀ Orí — Troca de Cabeça',
        category: 'health', subCategory: 'giga',
        purpose: 'Ritual supremo de substituição do Orí: um animal (Agbo ou Akuko) aceita o Iku destinado a uma pessoa em estado terminal. Este é o ritual mais complexo e sagrado de toda a tradição de Ifá — realizado SOMENTE quando Oyeku Meji ou Oyeku Ogbe aparecem e a morte é iminente.',
        nomeYoruba: 'Ìpadàbọ̀ Orí — Ìrọ́pò Orí',
        complexity: 'Perigosa',
        tags: ['Morte', 'Substituição', 'Vida', 'Emergência', 'Troca de Cabeça', 'Iku', 'Oyeku'],
        oduReference: 'Oyeku Meji',
        niveis: [{
            tipo: 'COMPLETO',
            estimativa_materiais: 25000,
            atencao: '⚠️ AVISO SAGRADO: Este ritual SÓ pode ser conduzido por um Babalawo após consulta formal com o Opon Ifá. O Odù revelado DEVE ser Oyeku Meji. O animal deve aceitar voluntariamente — se resistir, o ritual NÃO prossegue. Realizar sem confirmação oracular é interdito e perigoso para o operador.',
            materiais: [
                'Agbo (Carneiro) saudável sem defeitos — ou Akuko (Galo Preto) se o carneiro não estiver disponível',
                'Aso Dudu (Pano Preto) — para cobrir o doente durante a transferência',
                'Aso Funfun (Pano Branco) — para cobrir o doente após o ritual',
                'Owu Funfun (Linha de Algodão Branco) — para ligar o Orí do doente ao animal',
                'Iyerosun (Pó Sagrado de Irosun)',
                'Opon Ifá (Tabuleiro Sagrado)',
                'Ikin Ifá (Nozes de Palmeira Consagradas)',
                'Omi Tutu (Água Fresca)',
                'Obi Abata (Cola de 4 gomos)',
                'Oti (Cachaça/Gim) — para libações',
                'Epo Pupa (Dendê)',
                'Iya Omo Igi Iroko (Casca de Iroko) — árvore sagrada onde o Iku será ancorado'
            ],
            preparo: [
                'ABERTURA ORACULAR: O Babalawo marca Oyeku Meji no Opon Ifá com Iyerosun. Usa os Ikins para confirmar que o Iku ainda pode ser transferido. Se os Ikins negarem, o ritual encerra imediatamente.',
                'PREPARAÇÃO DO ESPAÇO: Afastar todos exceto o Babalawo e um assistente. Deitar o doente no chão (jamais na cama) sobre o Aso Dudu. Nenhum espelho pode estar presente no ambiente.',
                'CHAMADA DO ORÍ: O Babalawo segura a cabeça do doente com as duas mãos e recita o Ofó de Oyeku Meji 3 vezes, estabelecendo a ligação sagrada entre o Orí do doente e o animal escolhido.',
                'TRANSFERÊNCIA DO IKU: Usando o Owu Funfun, amarrar suavemente a testa do doente ao pescoço do animal. Recitar: "Orí re, gba eranko yi. Jeki Iku lo si iya rẹ" (Seu Orí, aceite este animal. Deixe o Iku ir para ele).',
                'SINAL DE ACEITAÇÃO: Observar o animal em silêncio. Se abaixar a cabeça espontaneamente — a transferência foi aceita pelo Orun. Se reagir com agitação extrema e prolongada — o Iku não pode ser transferido. O ritual encerra e o Babalawo deve rezar Egúngún.',
                'CORTE SAGRADO: O Babalawo sacrifica o animal com um único golpe limpo e rápido (não pode haver sofrimento prolongado). O Eje (sangue) cai sobre o Aso Dudu que estava sob o doente — o pano absorve o Iku.',
                'ENCERRAMENTO E DESPACHO: O Aso Dudu com o sangue é enrolado e despachado na raiz do Iroko — a árvore anciã recebe e retém o Iku dentro da terra. A casca de Iroko é enterrada sob a soleira da casa do doente como proteção permanente.',
                'PÓS-RITUAL (16 DIAS): O doente usa Aso Funfun (branco) por 16 dias completos. Proibido ver sangue, enterros ou morte de animais. O Babalawo retorna ao 8º e 16º dias para rezar Oyeku Meji sobre o doente e confirmar que o Iku foi ancorado.'
            ],
            ofo: 'Oyeku Meji so pe: Iku naa lo n je o. Eranko yi o je onile ile. Ki o lo gba Iku ti ko je tira re. Arewa, o ye! Agbo (Akuko) gba Iku. Iwo yeye. Oyeku pada seyin — Iku lo!',
            traducao: 'Oyeku Meji disse: É a Morte que te consome. Este animal não é o dono desta vida. Que ele vá aceitar a morte que não era sua. Pessoa sagrada, você sobrevive! O carneiro (galo) aceita o Iku. Você vive. Oyeku recue — a morte vai!'
        }]
    },
    {
        id: 'gi_oogun_iku',
        title: 'Oogun Iku (Ebó Preventivo de Vida)',
        category: 'health', subCategory: 'giga',
        purpose: 'Ebó preventivo para afastar o Iku quando Oyeku aparece na consulta mas a pessoa ainda não está em estado terminal. Diferente do Ìpadàbọ̀ Orí: este é profilático (preventivo), aquele é emergencial (substituição real).',
        nomeYoruba: 'Ọọgun Iku — Ebó Aiku',
        complexity: 'Perigosa',
        tags: ['Vida', 'Morte', 'Ebó', 'Oyeku', 'Preventivo'],
        oduReference: 'Oyeku Meji',
        niveis: [{
            tipo: 'COMPLETO',
            estimativa_materiais: 15000,
            atencao: '⚠️ ATENÇÃO: Apenas quando Oyeku Meji reger a consulta. Nunca realizar por conta própria.',
            materiais: [
                'Agbo (Carneiro)',
                'Aso Dudu (Pano Preto)',
                'Iya Omo Igi Iroko (Casca de Iroko)',
                'Iyerosun (Pó de Irosun)',
                'Omi Tutu (Água Fresca)',
                'Obi Abata (Cola de 4 gomos)'
            ],
            preparo: [
                'O Babalawo reza Oyeku Meji sobre o consulente usando o Opon Ifá.',
                'Vestir o consulente com Aso Dudu (Pano Preto) simbolicamente por alguns minutos.',
                'O Babalawo transfere a energia de Iku para o Agbo através da oração de substituição.',
                'Sacrificar o Agbo como substituto ritual. O Iku aceita o animal no lugar da pessoa.',
                'Enterrar o pano e parte do animal aos pés de Iroko, carregando e ancorando o Iku na terra sagrada.'
            ],
            ofo: 'Agbo gba Iku re. Iwo yeye. Oyeku pada seyin — Iku lo!',
            traducao: 'O carneiro aceita sua morte. Você vive. Oyeku recue — a morte vai!'
        }]
    },
    {
        id: 'gi_oogun_iran',
...
export const ASSENTAMENTOS_DB: AssentamentoItem[] = [
    // --- IGBA (ASSENTAMENTOS) ---
    {
        ...
        maintenance: { ciclo: '4 dias (Ose Ifa)', oferenda_simples: 'Obi e Oti', proibicoes: ['Mulheres menstruadas', 'Roupas escuras', 'Carne de porco'] },
        niveis: [
            {
                tipo: 'COMPLETO (Sacerdotal)',
                estimativa_materiais: 800,
                materiais: ['Ikin Ifá (16 a 21 sementes consagradas)', 'Pote de Porcelana ou Madeira com tampa', 'Pó de Iyerosun', 'Pena de Ekodidé', 'Búzios (Owo Eyo)', 'Otas (Pedras redondas)'],
                preparo: ['Lavagem dos Ikins com Omiero especial.', 'Colocação do Iyerosun no fundo.', 'Os Ikins descansam sobre o pó.', 'O Ekodidé é fixado na tampa.']
            }
        ]
    },
    {
        ...
        maintenance: { ciclo: 'Diário ou Semanal', oferenda_simples: 'Epo Pupa e Oti', proibicoes: ['Aje (Manteiga)', 'Mel (em alguns caminhos)'] },
        niveis: [
            {
                tipo: 'COMPLETO (Sacerdotal)',
                estimativa_materiais: 150,
                materiais: ['Pedra Yangí (Laterita)', 'Prato de barro', 'Epo Pupa', 'Oti', 'Atare', 'Moedas', 'Búzios'],
                preparo: ['Lavar a pedra Yangí para despertar o espírito.', 'Colocar no prato cercado de búzios e moedas.', 'Soprar Oti e Atare.', 'Cobrir com Dendê abundante.']
            }
        ]
    },
    {
        id: 'igba_obatala',
        orisha: 'Obatala',
        title: 'Igba Obatala (Pote da Paz)',
        nomeYoruba: 'Igbá Òrìṣanlá',
        description: 'O Deus da criação e da pureza. Traz paz, clareza mental e equilíbrio.',
        category: 'igba',
        ofo: "Obatala, o ri l'aye, o ri l'orun. Fun mi ni alafia e mo o.",
        maintenance: { ciclo: '8 dias (Ose Obatala)', oferenda_simples: 'Omi Tutu, Efun, Iyan', proibicoes: ['Epo Pupa (Dendê)', 'Iyo (Sal)', 'Ounje Gbigbona (Comida Quente)'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 500,
                materiais: ['Soeira de Louça Branca', '16 Otás Brancas', '16 búzios brancos', 'Efun (Giz)', 'Opaxoró de metal branco'],
                preparo: ['Lavar materiais com Omiero de Tete e Odundun.', 'Arrumar as pedras no fundo.', 'Cobrir com Efun ralado.', 'Adicionar o cajado simolicamente.']
            }
        ]
    },
    {
        ...
        maintenance: { ciclo: '21 dias', oferenda_simples: 'Epo, Ewa, Oti', proibicoes: ['Mentira', 'Traição'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 400,
                materiais: ['Pedra de Ferro', 'Ferramentas (7)', 'Corrente', 'Marias (Palmeira)', 'Epo Pupa', 'Inhame'],
    ...
    },
    {
        id: 'igba_oxossi',
        orisha: 'Oxossi',
        title: 'Assentamento de Oxossi',
        nomeYoruba: 'Igbá Ọ̀ṣọ́ọ̀sì',
        description: 'O caçador solitário. Traz fartura e foco.',
        category: 'igba',
        ofo: "Ode ni o gbe mi. Osoosi ni n pa eran fun mi.",
        maintenance: { ciclo: '7 dias', oferenda_simples: 'Milho (Ado), Frutas', proibicoes: ['Mel (para alguns)', 'Carne de Caça rito'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 450,
                materiais: ['Ofá de metal', 'Otá de mata', 'Cabaça (Ado)', 'Búzios (7)', 'Alguidar de barro'],
                preparo: ['Consagrar o Ofá com ervas.', 'Fixar a pedra no centro.', 'Cercar com búzios.', 'Oferecer milho com coco.']
            }
        ]
    },
    {
        ...
        description: 'Justiça e vitória real.',
        category: 'igba',
        ...
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 500,
                materiais: ['Edun Ara (Raio)', 'Orogbo (6)', 'Ose Dudu', 'Gamela', 'Oxe (Machado)', 'Sere'],
    ...
    },
    {
        ...
        description: 'Fertilidade, riqueza e amor.',
        category: 'igba',
        ...
        niveis: [
            {
                ...
                materiais: ['Otás de Rio (5)', 'Búzios (16)', 'Pente Latão', 'Espelho', 'Abébé', 'Louça Amarela'],
    ...
    },
    {
        id: 'igba_omolu',
        orisha: 'Omolu',
        title: 'Assentamento de Omolu',
        nomeYoruba: 'Igbá Ọbalúwáyé',
        description: 'Cura e proteção.',
        category: 'igba',
        ofo: "Obaluaye, a je ri oogun. Je ki n ye.",
        maintenance: { ciclo: 'Anual', oferenda_simples: 'Pipoca (Deburu)', proibicoes: ['Mel', 'Falar alto'] },
        niveis: [
            {
                tipo: 'COMPLETO (Sacerdotal)',
                estimativa_materiais: 900,
                materiais: ['Xaxará', 'Argila/Barro', 'Búzios', 'Terra preta', 'Azougue'],
                preparo: ['Modelar base em barro.', 'Incrustar búzios.', 'Consagrar em silêncio.']
            }
        ]
    },
    {
        id: 'igba_oya',
        orisha: 'Oya',
        title: 'Assentamento de Oya',
        nomeYoruba: 'Igbá Ọya',
        description: 'Transformação e ventos.',
        category: 'igba',
        ofo: "Oya afefe iku. Gbe ibi lo.",
        maintenance: { ciclo: '9 dias', oferenda_simples: 'Acarajé, Berinjela', proibicoes: ['Carne de Carneiro', 'Abóbora'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 550,
                materiais: ['Espada de Cobre', 'Iruquerê', '9 Otás', 'Louça vinho', 'Chifre Búfalo'],
                preparo: ['Lavar pedras em água de chuva.', 'Arrumar na louça.', 'Posicionar espada.', 'Oferecer acarajé.']
            }
        ]
    },
    {
        id: 'igba_yemoja',
        orisha: 'Yemoja',
        title: 'Assentamento de Yemoja',
        nomeYoruba: 'Igbá Yemọja',
        description: 'Maternidade e proteção.',
        category: 'igba',
        ofo: "Yemoja o lodo. Iyá mi, o mọ mi.",
        maintenance: { ciclo: '16 dias', oferenda_simples: 'Manjar, Peixe', proibicoes: ['Sal em excesso', 'Roupas rasgadas'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 650,
                materiais: ['Louça Azul/Branca', 'Conchas', 'Pedras de mar', 'Prata', 'Abebé'],
                preparo: ['Buscar água do mar.', 'Arrumar conchas e pedras.', 'Cobrir com água fresca.']
            }
        ]
    },
    {
        id: 'igba_nana',
        orisha: 'Nana',
        title: 'Assentamento de Nana',
        nomeYoruba: 'Igbá Nanà Burúkú',
        description: 'Ancestralidade e lama.',
        category: 'igba',
        ofo: "Nanà Burúkú, mọ́ ile. Paya mi.",
        maintenance: { ciclo: 'Anual', oferenda_simples: 'Efó, Batata Doce', proibicoes: ['Objetos de metal', 'Barulho'] },
        niveis: [
            {
                tipo: 'COMPLETO (Sacerdotal)',
                estimativa_materiais: 1200,
                materiais: ['Ibirí', 'Pote de barro', 'Lama', 'Búzios', 'Pedras escuras'],
                preparo: ['Trabalhar o barro sem metal.', 'Arrumar no pote.', 'Consagrar no rio.']
            }
        ]
    },
    {
        id: 'igba_osanyin',
        orisha: 'Osanyin',
        title: 'Assentamento de Osanyin',
        nomeYoruba: 'Igbá Ọ̀sanyìn',
        description: 'Ervas e medicina.',
        category: 'igba',
        ofo: "Ewe be n'ibo. Osanyin ni o mọ ewe jẹ.",
        maintenance: { ciclo: 'Diário (regar)', oferenda_simples: 'Fumo, Gim, Mel', proibicoes: ['Matas s/ licença', 'Queimar folhas'] },
        niveis: [
            {
                tipo: 'COMPLETO (Sacerdotal)',
                estimativa_materiais: 1500,
                materiais: ['Pote madeira', 'Ferramenta Pássaro', 'Cabaças pós', 'Folhas secas'],
                preparo: ['Fixar ferramenta no pote.', 'Cercar c/ cabaças.', 'Soprar Gim.']
            }
        ]
    },
    {
        id: 'igba_logunede',
        orisha: 'Logun Ede',
        title: 'Assentamento de Logun Ede',
        nomeYoruba: 'Igbá Lógun Odẹ',
        description: 'Equilíbrio e beleza.',
        category: 'igba',
        ofo: "Logun Ede akofiri. Omo Osun, omo Ode.",
        maintenance: { ciclo: '16 dias', oferenda_simples: 'Omolokun, Milho', proibicoes: ['Feijão preto', 'Roupas sujas'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 750,
                materiais: ['Ofá e Abebé', 'Dourado/Prateado', 'Otás rio/mata', 'Louça bicolor'],
                preparo: ['Combinar elementos Ode e Osun.', 'Lavar com mel.', 'Arrumar na louça.']
            }
        ]
    },
    {
        id: 'igba_ibeji',
        orisha: 'Ibeji',
        title: 'Assentamento de Ibeji',
        nomeYoruba: 'Igbá Ìbejì',
        description: 'Dualidade e sorte.',
        category: 'igba',
        ofo: "Ibeji mo ki o. E ba mi gbe omo mi.",
        maintenance: { ciclo: 'Semanal', oferenda_simples: 'Doces, Frutas', proibicoes: ['Tristeza', 'Faltar com a palavra'] },
        niveis: [
            {
                tipo: 'BÁSICO (Pessoal)',
                estimativa_materiais: 300,
                materiais: ['Dois Ere', 'Dois potes', 'Búzios', 'Brinquedos', 'Otás'],
                preparo: ['Lavar Ere c/ ervas doces.', 'Colocar nos potes.', 'Oferecer doces.']
            }
        ]
    },
    {
        id: 'igba_oba',
        orisha: 'Oba',
        title: 'Assentamento de Oba',
        nomeYoruba: 'Igbá Ọbà',
        description: 'Fidelidade e seriedade.',
        category: 'igba',
        ofo: "Oba sirê! Iyá mi, gbe mi.",
        maintenance: { ciclo: '21 dias', oferenda_simples: 'Acarajé, Inhame', proibicoes: ['Mentira amorosa', 'Traição'] },
        niveis: [
            {
                tipo: 'MÉDIO (Padrão)',
                estimativa_materiais: 500,
                materiais: ['Escudo cobre', 'Sabre', 'Roda madeira', 'Louça terra', 'Otá rio'],
                preparo: ['Lavar na beira do rio.', 'Arrumar escudo.', 'Oferecer c/ seriedade.']
            }
        ]
    },
    {
        id: 'igba_yewa',
        orisha: 'Yewa',
        title: 'Assentamento de Yewa',
        nomeYoruba: 'Igbá Yewà',
        description: 'Intuição e horizonte.',
        category: 'igba',
        ofo: "Yewa o! Iyá luba.",
        maintenance: { ciclo: 'Anual', oferenda_simples: 'Batata doce, Frutas', proibicoes: ['Visto p/ crianças', 'Porco'] },
        niveis: [
            {
                tipo: 'COMPLETO (Sacerdotal)',
                estimativa_materiais: 800,
                materiais: ['Ofá metal', 'Louça cobras', 'Otá vermelha', 'Cabaça pintada'],
                preparo: ['Ritual isolamento.', 'Pintura cabaça.', 'Fixação pedra.']
            }
        ]
    },
    {
