...
import { ArrowLeft, Book, Search, Filter, Scroll, Wand2, MessageCircle, Globe, Loader2, Sparkles } from 'lucide-react';
import TextReader from './TextReader';
import { normalizeText } from '../utils/textHelper';
import { fetchOriki } from '../services/geminiService';

// Extended Data Structure
type TextType = 'oriki' | 'adura' | 'ofo';
...
const SacredTextLibrary = ({ onBack }: { onBack: () => void }) => {
    ...
    const filteredTexts = useMemo(() => {
        ...
        const allTexts = [...SACRED_TEXTS_DB, ...generatedTexts];
        ...
        return allTexts.filter(item => {
            ...
            const matchTags = item.tags.some(t => normalizeText(t).includes(query));
